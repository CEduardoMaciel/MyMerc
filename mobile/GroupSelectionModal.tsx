    ...
    <Modal visible={visible} transparent animationType="slide">
      <View style={localStyles.modalOverlay}>
        <View style={[localStyles.modalContent, { width: '90%', maxHeight: '80%', backgroundColor: theme.modalBg }]}>
          <Text style={[styles.title, { fontSize: 20, marginBottom: 5 }]}>Selecione o Grupo</Text>
          ...
          <View style={{ width: '100%', flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' }}>
            {(Object.keys(groupIcons) as Array<Item['grupo']>).map((grupo) => (
              ...
              >
                <MaterialIcons name={groupIcons[grupo]} size={20} color={theme.logo} style={{ marginRight: 8 }} />
          ...
          <TouchableOpacity
            style={[styles.addBtn, { width: '100%', backgroundColor: theme.cancelBtn, marginTop: 10 }]}
            onPress={onCancel}
          >
